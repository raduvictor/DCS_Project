...
public class Controller {
    public static void main(String[] args) {
        ...
        grdT2.Activations.add(new Activation(t2, "R", TransitionOperation.SendOverNetwork, "OP4"));
        grdT2.Activations.add(new Activation(t2, "G", TransitionOperation.SendOverNetwork, "OP5"));
        ...
        Condition T3Ct1 = new Condition(t3, "in5", TransitionCondition.NotNull);
        ...
        grdT3.Activations.add(new Activation(t3, "Y", TransitionOperation.SendOverNetwork, "OP5"));
        ...
        grdT3_1.Activations.add(new Activation(t3, "Y", TransitionOperation.SendOverNetwork, "OP5"));
        ...
        grdT4.Activations.add(new Activation(t4, "R", TransitionOperation.SendOverNetwork, "OP5"));
        grdT4.Activations.add(new Activation(t4, "G", TransitionOperation.SendOverNetwork, "OP6"));
        ...
        Condition T5Ct1 = new Condition(t5, "in6", TransitionCondition.NotNull);
        ...
        grdT5.Activations.add(new Activation(t5, "Y", TransitionOperation.SendOverNetwork, "OP6"));
        ...
        grdT5_1.Activations.add(new Activation(t5, "Y", TransitionOperation.SendOverNetwork, "OP6"));
        ...
        grdT6.Activations.add(new Activation(t6, "R", TransitionOperation.SendOverNetwork, "OP6"));
