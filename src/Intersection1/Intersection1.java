...
import GUIs.InputString;
import Intersection2.Intersection2;
...
public class Intersection1 {
	public static void main(String[] args) {
		...
		P_street1.Value = new TransferOperation("localhost", "1081", "P_street2");
		...
		grdT_street1.Activations
				.add(new Activation(T_street1, "P_30", TransitionOperation.SendOverNetwork, "P_street1"));
		...
		//
		// Condition T_street2Ct1 = new Condition(T_street2, "P_street1",
		// TransitionCondition.NotNull);
		//
		// GuardMapping grdT_street2 = new GuardMapping();
		// grdT_street2.condition = T_street2Ct1;
		// grdT_street2.Activations.add(new Activation(T_street2, "P_street1",
		// TransitionOperation.SendOverNetwork, "P_street2"));
		//
		...
		Intersection2.main(new String[0]);
		// InputCar.main(new String[0]);
		// InputString.main(new String[0]);
	}
}
